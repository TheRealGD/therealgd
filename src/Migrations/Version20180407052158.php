 ...
 */
class Version20180407052158 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE report (id BIGINT NOT NULL, submission_id BIGINT DEFAULT NULL, comment_id BIGINT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report_entry (id BIGINT NOT NULL, report_id BIGINT DEFAULT NULL, body TEXT NOT NULL, PRIMARY KEY(id))');
